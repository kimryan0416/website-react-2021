...
function MoL() {
	...
	const headerTable = [
		...
		{
			key: "Dates",
			value: (<p>January 2020 - May 10, 2020</p>)
		},
		{
			key: "External Links",
			value: (
				<ul>
					...
					<li><ExtURL href="https://drive.google.com/drive/folders/1YcBCD0vUy0Oj_lybbf-ZRvfHFcLavCcc?usp=sharing">Downloadable Build &amp; Files</ExtURL></li>
					<li><ExtURL href="https://youtu.be/AhC4hOWlfGY">Video Demonstration (YouTube)</ExtURL></li>
				</ul>
			)
		},
		{
	...
	return (
		<div className="PortfolioContent">
			...
			<div className="PortfolioMain">
				...
				<Divider space={16} />
				<h4><strong>Researchers</strong></h4>
				<Divider space={8} />
				<ul>
