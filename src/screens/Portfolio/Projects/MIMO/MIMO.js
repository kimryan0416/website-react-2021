	...
	return (
		<div className="PortfolioContent">
			...
			<div className="PortfolioMain">
				...
				<Divider space={8} />
				<p>I was allowed to decide not just what the content was but also how they would build off of one another sequentially across the eight Skills. As “React Basics” was meant for newcomers to React.js, I had to consider how to convey the lesson content in a manner that was easy to understand. The planning phase of the development process took the largest amount of time, whereas the implementation of lesson content into MIMO’s infrastructure took less time as a result of careful planning and adherence to MIMO’s content guidelines.</p>
				<Divider space={16} />
